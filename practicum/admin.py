...
@admin.register(MajorContent)
class MajorContentAdmin(admin.ModelAdmin):
    list_display = ('id', 'title', 'major', 'content_type', 'created_at', 'updated_at')
    search_fields = ('title', 'major__title')
    list_filter = ('major', 'content_type', 'created_at')
